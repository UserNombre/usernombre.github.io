...
- In the middle of writing this article I came across [this](https://0xax.gitbooks.io/linux-insides/content/SysCall/linux-syscall-4.html)
post, which explores the topic in a similar manner. A bit discouraged, hopefully more detailed.
